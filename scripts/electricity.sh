...
do
    #----------------------------------predict length 96---------------------------------------
    python run.py --seed $seed --data electricity --batch_size 4 --moving_avg '13, 17' \
    --seq_len 720 --label_len 96 --pred_len 96 --embed_dim 8 \
    --learning_rate 5e-5 --patch_size '4, 8, 12, 24, 48'
    ...
    --learning_rate 5e-5 --patch_size '12, 24, 48'
done
